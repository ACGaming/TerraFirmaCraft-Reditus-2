...
// Atomizer.removeRecipe(ILiquidStack input);

	// WATER
	Atomizer.removeRecipe(<liquid:water>);
	Atomizer.addRecipe(<alchemistry:compound:7> * 8, <liquid:fresh_water>);
	Atomizer.addRecipe(<alchemistry:compound:7> * 8, <liquid:salt_water>);
	Atomizer.addRecipe(<alchemistry:element:26> * 16, <liquid:wrought_iron>);

// ----------------
// --- COMBINER ---
// ----------------
// Combiner.addRecipe(IItemStack output, IItemstack[] input);
// Combiner.removeRecipe(IItemStack output);
...
// --- ELECTROLYZER ---
// --------------------
// Electrolyzer.addRecipe(ILiquidStack input, IItemStack input, int electrolyteConsumptionChance, IItemStack output, IItemStack output2, @Nullable IItemStack output3, @Nullable int output3Chance, @Nullable IItemStack output4, @Nullable int output4Chance);
// Electrolyzer.removeRecipe(ILiquidStack input, IItemStack input);

	// WATER
	Electrolyzer.addRecipe(<liquid:fresh_water> * 125, <alchemistry:compound:13>, 20, <alchemistry:element:1> * 4, <alchemistry:element:8> * 2, null, null, null, null);
	Electrolyzer.addRecipe(<liquid:fresh_water> * 125, <alchemistry:compound:6>, 20, <alchemistry:element:1> * 2, <alchemistry:element:8>, <alchemistry:element:17>, 10, null, null);
...
// Evaporator.removeRecipe(ILiquidStack input); //Will work regardless of quantity
	...
	// MINERAL SALT
	Evaporator.removeRecipe(<liquid:water>);
	Evaporator.addRecipe(<alchemistry:mineral_salt>, <liquid:fresh_water> * 125);
	Evaporator.addRecipe(<alchemistry:mineral_salt> * 2, <liquid:salt_water> * 125);