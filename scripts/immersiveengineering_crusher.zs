...
Crusher.addRecipe(<minecraft:dye:10> * 6, <ore:gemOlivine>, 4096);
Crusher.addRecipe(<minecraft:dye:2> * 6, <ore:gemSerpentine>, 4096);
Crusher.addRecipe(<minecraft:dye:6> * 6, <ore:gemMicrocline>, 4096);
Crusher.addRecipe(<minecraft:glowstone_dust> * 4, <ore:glowstone>, 4096);
Crusher.addRecipe(<minecraft:glowstone_dust> * 8, <ore:gemSatinspar>, 4096);
Crusher.addRecipe(<minecraft:glowstone_dust> * 8, <ore:gemSelenite>, 4096);
Crusher.addRecipe(<minecraft:redstone> * 8, <ore:gemCinnabar>, 4096);
Crusher.addRecipe(<minecraft:redstone> * 8, <ore:gemCryolite>, 4096);
...
Crusher.addRecipe(<tfc:powder/charcoal> * 8, <ore:gemPetrifiedWood>, 4096);
Crusher.addRecipe(<tfc:powder/fertilizer> * 8, <ore:gemSylvite>, 4096);
Crusher.addRecipe(<tfc:powder/flux> * 6, <ore:rockFlux>, 4096);
Crusher.addRecipe(<tfc:powder/flux> * 8, <ore:gemBorax>, 4096, <minecraft:dye:15> * 3, 0.5);
Crusher.addRecipe(<tfc:powder/graphite> * 8, <ore:gemGraphite>, 4096);
Crusher.addRecipe(<tfc:powder/kaolinite> * 8, <ore:gemKaolinite>, 4096);
Crusher.addRecipe(<tfc:powder/lapis_lazuli> * 8, <ore:gemLapis>, 4096);
Crusher.addRecipe(<tfc:powder/salt> * 6, <tfc:ore/halite>, 4096);
...
Crusher.addRecipe(<tfc:powder/saltpeter> * 8, <ore:gemSaltpeter>, 4096);
Crusher.addRecipe(<tfc:powder/sulfur> * 8, <ore:gemSulfur>, 4096);
Crusher.addRecipe(<tfc:powder/sulfur> * 8, <ore:gemSulfur>, 4096, <minecraft:blaze_powder> * 2, 0.5);
...
Crusher.addRecipe(<tfctech:powder/lime> * 4, <contenttweaker:seashell>, 2048);
