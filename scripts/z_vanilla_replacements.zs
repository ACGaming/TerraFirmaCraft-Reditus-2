...
// DOORS
recipes.replaceAllOccurences(<minecraft:acacia_door>, <ore:doorWoodAcacia>);
recipes.replaceAllOccurences(<minecraft:birch_door>, <ore:doorWoodBirch>);
recipes.replaceAllOccurences(<minecraft:dark_oak_door>, <ore:doorWoodHickory>);
recipes.replaceAllOccurences(<minecraft:jungle_door>, <ore:doorWoodSequoia>);
recipes.replaceAllOccurences(<minecraft:spruce_door>, <ore:doorWoodSpruce>);
recipes.replaceAllOccurences(<minecraft:wooden_door>, <ore:doorWoodOak>);

// BOATS
recipes.replaceAllOccurences(<minecraft:boat>, <tfc:wood/boat/oak>);
recipes.replaceAllOccurences(<minecraft:spruce_boat>, <tfc:wood/boat/spruce>);
recipes.replaceAllOccurences(<minecraft:birch_boat>, <tfc:wood/boat/birch>);
recipes.replaceAllOccurences(<minecraft:jungle_boat>, <tfc:wood/boat/sequoia>);
recipes.replaceAllOccurences(<minecraft:acacia_boat>, <tfc:wood/boat/acacia>);
recipes.replaceAllOccurences(<minecraft:dark_oak_boat>, <tfc:wood/boat/hickory>);
...
recipes.replaceAllOccurences(<minecraft:hardened_clay>, <tfc:fire_bricks>);
recipes.replaceAllOccurences(<minecraft:red_sandstone>, <ore:sandstone>);
