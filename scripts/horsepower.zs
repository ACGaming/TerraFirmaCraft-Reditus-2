...
ChoppingBlock.add(<tfc:wood/log/hevea:0>, <tfc:wood/lumber/hevea> * 12, 4, false);
...
Press.add(<immersiveengineering:material:4> * 24, <tfc:crop/product/burlap_cloth>);
Press.add(<minecraft:string> * 32, <tfc:animal/product/silk_cloth>);
Press.add(<ore:logWoodTannin>, <liquid:creosote> * 125);
Press.add(<tfc:animal/product/wool_yarn> * 24, <tfc:animal/product/wool_cloth>);
Press.add(<tfc:crop/product/jute_fiber> * 16, <tfc:crop/product/burlap_cloth>);
